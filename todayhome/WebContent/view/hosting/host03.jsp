    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="padding:35px 50px;">
          ...
          <h4><span class="glyphicon glyphicon-lock"></span> 호스팅 확인</h4>
        </div>
        
        <div class="modal-body" style="padding:40px 50px;">
            <div class="form-group">
              <label for="usrname"><span class="glyphicon glyphicon-ok"></span> 제목</label>
              <input type="text" class="form-control" id="usrname" value="${hostinginfo.title}" readonly="readonly">
              
              <label for="usrname"><span class="glyphicon glyphicon-home"></span> 숙소유형</label>
              <input type="text" class="form-control" id="usrname" value="${hostinginfo.htype}" readonly="readonly">
              
              <label for="usrname"><span class="glyphicon glyphicon-home"></span> 방유형</label>
              <input type="text" class="form-control" id="usrname" value="${hostinginfo.rtype}" readonly="readonly">
              
              <label for="usrname"><span class="glyphicon glyphicon-home"></span> 방개수</label>
              <input type="text" class="form-control" id="usrname" value="${hostinginfo.roomcnt}" readonly="readonly">
              
              <label for="usrname"><span class="glyphicon glyphicon-home"></span> 수용인원</label>
              <input type="text" class="form-control" id="usrname" value="${hostinginfo.membercnt}" readonly="readonly">
              
              <label for="usrname"><span class="glyphicon glyphicon-home"></span> 침대개수</label>
              <input type="text" class="form-control" id="usrname" value="${hostinginfo.bedcnt}" readonly="readonly">
              
              <label for="usrname"><span class="glyphicon glyphicon-home"></span> 욕실개수</label>
              <input type="text" class="form-control" id="usrname" value="${hostinginfo.bathcnt}" readonly="readonly">
              
               <label for="usrname"><span class="glyphicon glyphicon-map-marker"></span> 국가</label>
              <input type="text" class="form-control" id="usrname" value="${hostinginfo.country}" readonly="readonly">
              
              <label for="usrname"><span class="glyphicon glyphicon-map-marker"></span> 도시</label>
              <input type="text" class="form-control" id="usrname" value="${hostinginfo.city}" readonly="readonly">
              
              <label for="usrname"><span class="glyphicon glyphicon-map-marker"></span> 하위주소</label>
              <input type="text" class="form-control" id="usrname" value="${hostinginfo.location}" readonly="readonly">
            </div>     
        
            <div class="form-group">
            </div>
              <button class="btn btn-success btn-block" id="tomain"><span class="glyphicon glyphicon-off"></span> 메인 화면으로</button>
               <button class="btn btn-success btn-block" id="topicture"><span class="glyphicon glyphicon-picture"></span> 사진 추가하기</button>
              <script>
